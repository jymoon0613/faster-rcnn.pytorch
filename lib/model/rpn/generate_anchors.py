...
def _ratio_enum(anchor, ratios):
    ...
    # 주어진 reference box의 너비, 높이, 중심좌표 계산
    w, h, x_ctr, y_ctr = _whctrs(anchor) # 16, 16, 7.5, 7.5
    size = w * h # reference box의 크기 = 16 x 16 = 256
...
def _scale_enum(anchor, scales):
    ...
    # reference box의 너비를 서로 다른 scale ratio로 boradcasting
    ws = w * scales # w * [8, 16, 32] = [8w, 16w, 32w]
    # reference box의 높이를 서로 다른 scale ratio로 boradcasting
